        ...
        <div className="row">
          <div className="col-md-6 w-100">
            <div className="px-5">
              ...
              >
                Saya adalah seorang Front End Developer yang bertempat tinggal
                di Indonesia. Mempunyai <i>passion</i> untuk membuat tampilan
                website dengan animasi-animasi yang menarik dan kreatif, serta
                membuat website tersebut bekerja dinamis sesuai sistem.
                <br />
                <br />
                ...
                <br />
                <br />
                Tertarik dengan berbagai project web developer terutama di
                bagian frontend dan dapat bekerja sama dengan{" "}
                <i>positive people</i>.
              </div>
            </div>
          </div>
        </div>
        <div className="text-white w-100 col-md-6">tes</div>
      </div>
    </Layout>
  );
};
